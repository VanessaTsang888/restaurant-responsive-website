...
Show users how yummy the food looks.
[Use the 12 photos we provided]

### Customer testimonials

Social proofs. Show users that other users already purchased a subscription.
...
- Navigations (single page but still need internal nav) -> each section is like a mini page.
- Hero
- Featured in (logos)
- How it works
- Meals (list of diets)
